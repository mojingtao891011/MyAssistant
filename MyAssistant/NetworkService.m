...
+ (instancetype)sharedClient
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        _sharedClient.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json", @"text/json", @"text/javascript",@"text/html", nil];//[NSSet setWithObject:@"text/html"];//
    });
...
//    NSData *data = [NSData dataWithContentsOfFile:filePath];
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url fileName:fileName name:@"upfile" fileData:fileData];//[NSMutableURLRequest requestWithURL:url fileURL:fileURL name:@"upfile" fileData:data];
